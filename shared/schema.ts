...
export const auctions = pgTable('auctions', {
  ...
  currentPrice: decimal('current_price', { precision: 10, scale: 2 })
    .notNull()
    .default('0.00'),
  bidIncrement: decimal('bid_increment', { precision: 10, scale: 2 })
    .notNull()
    .default('0.01'),
...
export const settings = pgTable('settings', {
  ...
  footerDescription: text('footer_description').default(
    'პირველი პენი-აუქციონის პლატფორმა საქართველოში. მოიგეთ პრემიუმ ნივთები  ჩვენი სამართლიანი და გამჭვირვალე აუქციონის სისტემით.',
  ),
