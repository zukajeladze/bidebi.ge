...
export default function TermsOfService() {
  useDocumentTitle(
    'მომსახურების პირობები - bidebi.ge.GE | მომხმარებლის შეთანხმება',
  );
  ...
  const termsSections = [
    ...
    },
    {
      ...
      content: [
        ...
        'bidebi.ge.GE არის პენი-აუქციონების პლატფორმა საქართველოში, რომელიც უზრუნველყოფს გამჭვირვალე და სანდო აუქციონების ჩატარებას.',
  ...
  const liabilityItems = [
    {
      ...
      description:
        'bidebi.ge.GE არ არის პასუხისმგებელი არაპირდაპირ ზარალზე, მიუღებელ შემოსავალზე ან მორალურ ზიანზე.',
    },
    {
      title: 'პროდუქტების ხარისხი',
      description:
        'ადმინისტრაცია ცდილობს მიაწოდოს ზუსტი ინფორმაცია პროდუქტების შესახებ, მაგრამ არ იძლევა შეცდომების არარსებობის გარანტიას.',
    },
    {
      title: 'ტექნიკური შეფერხებები',
      description:
        'ტექნიკური პრობლემების შემთხვევაში ადმინისტრაცია იღებს ზომებს მათ უმოკლეს ვადებში აღმოსაფხვრელად.',
    },
    {
      title: 'მომხმარებელთა ქმედებები',
      description:
        'თითოეული მომხმარებელი პირადად არის პასუხისმგებელი თავის ქმედებებზე პლატფორმაზე.',
    },
  ];
      ...
      <main className="max-w-[1504px] mx-auto py-8 px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            მომხმარებლის შეთანხმება განსაზღვრავს bidebi.ge.GE პლატფორმის
            გამოყენების წესებსა და პირობებს.
          </p>
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>
              შემდეგი ქმედებები მკაცრად აკრძალულია და შეიძლება გამოიწვიოს
              ანგარიშის დაბლოკვა
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>
              მნიშვნელოვანი ინფორმაცია პასუხისმგებლობის შეზღუდვებისა და
              გარანტიების შესახებ
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <h3 className="font-semibold text-blue-800 mb-2">
                  სასამართლომდელი მოგვარება
                </h3>
                <p className="text-blue-700 text-sm">
                  ყველა დავა პირველ რიგში განიხილება მოლაპარაკებების გზით.
                  კონფლიქტური სიტუაციების გადასაჭრელად მიმართეთ მხარდაჭერის
                  სამსახურს.
                </p>
              </div>
              ...
              <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                ...
                <p className="text-orange-700 text-sm">
                  ეს პირობები რეგულირდება საქართველოს კანონმდებლობით. დავები
                  განიხილება საქართველოს სასამართლოებში.
                </p>
              </div>
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-green-700 text-sm">
                  პრეტენზიები უნდა გაიგზავნოს სადავო სიტუაციის წარმოშობიდან 30
                  დღის განმავლობაში.
                </p>
              </div>
            </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3 text-sm text-gray-600">
                <p>
                  ადმინისტრაციას უფლება აქვს შეცვალოს მომსახურების პირობები
                  ნებისმიერ დროს.
                </p>
                <p>ცვლილებები ძალაში შედის საიტზე გამოქვეყნებისთანავე.</p>
                <p>
                  სერვისის გამოყენების გაგრძელება ნიშნავს თანხმობას ახალ
                  პირობებზე.
                </p>
