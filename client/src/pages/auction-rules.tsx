...
export default function AuctionRules() {
  useDocumentTitle(
    'აუქციონის წესები - bidebi.ge.GE | პენი-აუქციონების პირობები',
  );
  ...
  const rulesSections = [
    {
      ...
      color: 'green',
      rules: [
        'დარეგისტრირდით bidebi.ge.GE-ზე',
      ...
      <main className="max-w-[1504px] mx-auto py-8 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {rulesSections.map((section, index) => (
            <Card
              ...
              data-testid={`card-rules-${index}`}
            >
              <CardHeader>
                <CardTitle className="flex items-center">
                  <div
                    className={`w-12 h-12 bg-${section.color}-100 rounded-lg flex items-center justify-center mr-4`}
                  >
                    <i
                      className={`${section.icon} text-${section.color}-600 text-xl`}
                    ></i>
                  </div>
                  {section.title}
                </CardTitle>
                ...
                <ul className="space-y-3">
                  {section.rules.map((rule, ruleIndex) => (
                    <li
                      ...
                      data-testid={`rule-${index}-${ruleIndex}`}
                    >
        ...
        <Card className="mb-12">
          <CardHeader>
            ...
            <CardDescription>
              ამ წესების დარღვევა გამოიწვევს ანგარიშის დაბლოკვას თანხის
              დაბრუნების გარეშე
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              <div
                ...
                data-testid="note-responsibility"
              >
                <h3 className="font-semibold text-yellow-800 mb-2">
                  მონაწილის პასუხისმგებლობა
                </h3>
                <p className="text-yellow-700">
                  აუქციონებში მონაწილეობით თქვენ ეთანხმებით, რომ გესმით პენი
                  აუქციონების მუშაობის პრინციპი და იღებთ შესაძლო რისკებს.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-blue-700">
                  აუქციონის დროს ტექნიკური პრობლემების შემთხვევაში დაუყოვნებლივ
                  დაუკავშირდით მხარდაჭერის სამსახურს. კომპენსაცია შესაძლებელია
                  მხოლოდ დადასტურებული ტექნიკური პრობლემების შემთხვევაში.
                </p>
              </div>

              <div
                className="p-4 bg-green-50 border border-green-200 rounded-lg"
                data-testid="note-fairplay"
              >
                <h3 className="font-semibold text-green-800 mb-2">
                  სამართლიანი თამაში
                </h3>
                <p className="text-green-700">
                  bidebi.ge.GE ცდილობს უზრუნველყოს სამართლიანი და გამჭვირვალე
                  აუქციონები ყველა მონაწილისთვის. ჩვენ მუდმივად ვაკონტროლებთ
                  სისტემას თაღლითობის თავიდან ასაცილებლად.
                </p>
              </div>
            </div>
          </CardContent>
