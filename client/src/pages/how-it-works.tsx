      ...
      <main className="max-w-[1504px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-3xl shadow-md border border-gray-200 p-8 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">{t('simpleGuideSubtitle')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">
                    {t('after50Bids').replace(
                      '{currency}',
                      formatCurrency(0.01),
                    )}
                  </span>
                  <span className="font-semibold">{formatCurrency(0.5)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">
