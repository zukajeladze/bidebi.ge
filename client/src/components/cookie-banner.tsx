          ...
          {!showSettings ? (
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                <Cookie className="h-6 w-6 text-yellow-500 flex-shrink-0 mt-0.5" />
                ...
                <Button
                  ...
                  className="p-1 flex-shrink-0 -mt-1"
                  aria-label="Close"
                >
                  <X className="h-4 w-4" />
                </Button>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                ...
                <Button
                  ...
                  className="bg-yellow-500 hover:bg-yellow-600 text-sm w-full sm:w-auto"
                >
                  {t("acceptAll")}
                </Button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
                <div className="bg-green-50 p-3 rounded border-l-2 border-green-500">
                  ...
                  <div className="text-green-600 mt-1 text-xs sm:text-sm">{t("basicSiteWork")}</div>
                </div>
                <div className="bg-blue-50 p-3 rounded border-l-2 border-blue-500">
                  <div className="font-medium text-blue-800">{t("analytical")}</div>
                  <div className="text-blue-600 mt-1 text-xs sm:text-sm">{t("siteImprovement")}</div>
                </div>
                <div className="bg-purple-50 p-3 rounded border-l-2 border-purple-500">
                  ...
                  <div className="text-purple-600 mt-1 text-xs sm:text-sm">{t("rememberSettings")}</div>
                </div>
              </div>
